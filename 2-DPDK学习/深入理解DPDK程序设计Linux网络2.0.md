hi，大家好，由于**移动互联网**不断发展，导致**网络流量徒增**，推动着网络技术不断地发展，而CPU的运行频率基本停留在10年前的水平，为了迎接超高速网络技术的挑战，软件也需要大幅度**创新**，结合硬件技术的发展，**DPDK**（Data Plane Development Kit），一个以软件优化为主的数据面技术应时而生，它为今天**NFV**技术的发展提供了绝佳的平台可行性。  
